...
must_replace("@media print{", "aside.right button{height:29px}#donateWrap{position:relative;margin-top:10px}#donateBtn{width:100%;font-weight:600;display:flex;align-items:center;justify-content:center;gap:5px}#donateBtn img{width:24px;height:24px;object-fit:contain}#donateMenu{display:none;position:fixed;z-index:75;background:#fff;border:1px solid #c8c8ce;border-radius:7px;box-shadow:0 10px 28px rgba(0,0,0,.18);padding:13px;font-size:14px;line-height:1.45;white-space:normal;overflow-y:auto}#donateMenu.open{display:block}#donateQrArea{display:none;text-align:center;margin-top:8px}#donateMenu.open~#donateQrArea{display:block}#donateQrImage{display:block;width:min(100%,210px);height:auto;aspect-ratio:1;margin:auto;image-rendering:pixelated}\n@media print{")
