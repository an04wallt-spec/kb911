...
function New-KB911Icon([string]$OutPath,[System.Drawing.Color]$Background){
  $size=256
  ...
  $bgBrush=[System.Drawing.SolidBrush]::new($Background);$g.FillPath($bgBrush,$path)
  ...
  $brushBlue.Dispose();$arrowPen.Dispose();$whiteBrush.Dispose();$font911.Dispose();$kbFont.Dispose();$pen.Dispose();$bgBrush.Dispose();$path.Dispose();$sf.Dispose();$g.Dispose();$bmp.Dispose()
}

New-KB911Icon 'build\KB911_icon.png' ([System.Drawing.Color]::FromArgb(255,17,22,28))
New-KB911Icon 'build\KB911_project_icon.png' ([System.Drawing.Color]::FromArgb(255,103,110,120))
